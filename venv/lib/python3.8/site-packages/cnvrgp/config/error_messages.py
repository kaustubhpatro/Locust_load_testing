...
# ATTRIBUTES
ATTRIBUTE_BAD_TYPE = "Wrong attribute type, expected {0}, got {1}"
...
# CLONE
CONFIG_YAML_NOT_FOUND = "Couldn't find config.yaml. Please clone project/dataset before syncing."
...
# ARGUMENTS
SERIES_NOT_A_LIST = "series must be a list of (x, y) tuples"
