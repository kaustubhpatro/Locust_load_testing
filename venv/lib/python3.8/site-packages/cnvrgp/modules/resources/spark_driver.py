...
from cnvrgp.modules.resources.templates.spark_templates_client import SparkTemplatesClient
...
class SparkDriver(DynamicAttributes):
    ...
    def _init_clients(self):
        ...
        try:
            ...
            raise CnvrgError(error_messages.FAILED_TO_INIT_CLIENT.format('templates'))
