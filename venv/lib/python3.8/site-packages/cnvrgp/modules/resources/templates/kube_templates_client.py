...
from cnvrgp.utils.validators import attributes_validator, validate_gpu, validate_template_type
from cnvrgp.modules.resources.templates.kube_template import KubeTemplate
...
class KubeTemplatesClient:
    ...
    def get(self, slug):
        ...
        if not slug or not isinstance(slug, str):
            raise CnvrgError(error_messages.TEMPLATE_GET_FAULTY_SLUG)
