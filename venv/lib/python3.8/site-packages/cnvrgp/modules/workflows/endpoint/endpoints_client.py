from cnvrgp.config.error_messages import EMPTY_KAFKA_BROKERS_LIST, EMPTY_KAFKA_INPUT_TOPICS
...
from cnvrgp.modules.workflows import Endpoint, EndpointKind, EndpointEnvSetup
...
class EndpointsClient(WorkflowsBase):
    ...
    def create(self,
        ...
        @param kind: Integer representing the endpoints type
        ...
        @param env_setup: The interpreter to use
