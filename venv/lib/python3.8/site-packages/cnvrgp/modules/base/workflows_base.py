...
from cnvrgp.context import Context
...
class WorkflowsBase:
    ...
    def get(self, slug):
        ...
        if not slug or not isinstance(slug, str):
            raise CnvrgError(error_messages.PROJECT_GET_FAULTY_SLUG)
    ...
    def delete(self, slugs):
        ...
        @return: None
        """
        delete_url = urljoin(self._route, routes.WORKFLOW_BULK_DELETE_SUFFIX)
    ...
    def stop(self, slugs, sync=False):
        ...
        @return: None
        """
        stop_url = urljoin(self._route, routes.WORKFLOW_BULK_STOP_SUFFIX)
    ...
    def sync(self, slugs, commit_msg=None):
        """
        Stopping multiple workflows
        @param slugs: List of workflow slugs to be stopped
        ...
        @return: None
        """
        stop_url = urljoin(self._route, routes.WORKFLOW_BULK_SYNC_SUFFIX)
