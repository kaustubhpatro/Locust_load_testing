...
class LocalFileDeleter(RemoteFilesHandler):
    def __init__(self, data_owner, num_workers=40, queue_size=5000, chunk_size=1000, force=False):
        """
        ...
        super().__init__(
            ...
            force=force,
            base_commit_sha1=data_owner.current_commit,
    ...
    def _handle_file_function(self, local_path, **kwargs):
        """
        Function that creates fullpath.deleted file in .tmp that in the end of the whole task will cause deletion of fullpath
